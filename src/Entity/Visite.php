...
class Visite
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Enivronnement::class)
     */
    ...
    public function addEnvironnement(Enivronnement $environnement): self
    {
    ...
    public function removeEnvironnement(Enivronnement $environnement): self
    {
